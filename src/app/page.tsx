...
const Dashboard = async () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-teal-400 via-cyan-500 to-blue-500 px-5 pt-1 pb-4 relative">
      {/* Animated background elements */}
      <BackgroundElement />
      <div className="max-w-8xl mx-auto relative z-10">
        {/* Header */}
        <MainHeader dataExcel={dataExcel} />
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[1fr_2fr_1fr] gap-4 h-[85vh]">
