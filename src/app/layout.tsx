...
//                  <div className="text-sm font-semibold hover:text-yellow-300 transition-colors duration-300">
//                 KEMENTERIAN KELAUTAN DAN PERIKANAN
//               </div>
//               <div className="text-2xl font-bold text-yellow-400 hover:text-yellow-200 transition-colors duration-300 cursor-default">
//                 DIREKTORAT JENDERAL PERIKANAN TANGKAP
//               </div>
             
//             </div>
//             {/* Logo Kementerian */}
//             <div className="w-30 h-30 mr-10 transform hover:scale-110 transition-transform duration-300 hover:-rotate-3">
//               <img
