...
export default function CardChart(props: CardChartProps) {
  ...
  return (
    <div
      className={clsx(
        "from-teal-700 to-teal-800 rounded-xl p-4 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:scale-105 flex items-center justify-center cursor-pointer group",
        {
